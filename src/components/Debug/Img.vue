        ...
        <div>
          <el-menu
            ...
            <el-submenu index="1">
              ...
              <el-menu-item-group >
                <el-menu-item index="/debug/img" @click="goTo('/debug/img')">传入图片</el-menu-item>
              </el-menu-item-group>
              <el-menu-item-group >
                <el-menu-item index="/debug/text" @click="goTo('/debug/text')">传入文字</el-menu-item>
              </el-menu-item-group>
              <el-menu-item-group >
                <el-menu-item index="/debug/video" @click="goTo('/debug/video')">传入视频</el-menu-item>
              </el-menu-item-group>
