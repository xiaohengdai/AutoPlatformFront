...
<!--          list-type="picture-card">--> <!--上传后的图片可以对其删除-->
        ...
        <el-button style="margin-down: 100px;" size="medium" type="warning" @click="startRun">start run</el-button>
        <el-tag style="margin-down: 100px;" size="medium">将文件拖到此处，或<em>点击上传</em>,只能上传1张jpg/png文件</el-tag>
      </div>
    </div>
